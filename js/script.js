...
class App {
  ...
  canvasInit() {
    ...
    context.plane = ui.plane.getContext('2d', { willReadFrequently: true })
    ...
    context.main = ui.main.getContext('2d', { willReadFrequently: true })
